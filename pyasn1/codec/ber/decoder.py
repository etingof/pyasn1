...
class AnyDecoder(AbstractSimpleDecoder):
    ...
    def valueDecoder(self, substrate, asn1Spec,
        ...
        return self._createComponent(asn1Spec, tagSet, value=head, **options), tail
...
#:
#: nativeMode: :py:class:`bool`
#:     If `True`, produces Python objects as opposed to ASN.1 schema instance.
#:
#: Returns
#: -------
#: : :py:class:`tuple`
